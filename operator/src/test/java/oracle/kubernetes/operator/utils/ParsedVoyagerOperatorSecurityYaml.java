...
public class ParsedVoyagerOperatorSecurityYaml extends ParsedKubernetesYaml {
  ...
  public ParsedVoyagerOperatorSecurityYaml(Path yamlPath, CreateDomainInputs inputs) throws Exception {
    super(yamlPath);
    this.inputs = inputs;
  }
  ...
  public V1beta1ClusterRole getVoyagerEditClusterRole() {
    return getClusterRoles().find("appscode:voyager:edit");
  }

  public V1beta1ClusterRole getVoyagerViewClusterRole() {
